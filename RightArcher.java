...
public class RightArcher  extends Enemies 
   {
    private int ctr;
    ...
    public RightArcher (int stopPoint, int speed, int angle, int start)
       {
        ctr = 30;
    ...
    public void createArrowRight()
       {
        ...
        if(ctr>=startCounter)
           {
            ((CastleBusters)getWorld()).addObject(new Arrowright(this.getX(), arrowstopPoint, arrowspeed, arrowAngle, this.getY()), this.getX(), this.getY());
            ctr=0;
           }
       }
